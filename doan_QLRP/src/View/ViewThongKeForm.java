...
public class ViewThongKeForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewThongKeForm
     */
    public ViewThongKeForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panelForm.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/cinema.jpg"))); // NOI18N
        ...
        jButton2.setText("Danh sách nhập hàng theo nhà cung cấp");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ViewThongKeDoanhThuInput viewThongKeDoanhThuInput = new ViewThongKeDoanhThuInput();
        viewThongKeDoanhThuInput.setViewThongKeForm(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThongKeForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

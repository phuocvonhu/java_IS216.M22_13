...
public class HoaDonVeDAO {
    ...
    public static int insert( Connection cons, HoaDonVe h){
    ...
    public static int delete( Connection cons, HoaDonVe h){
        if(cons == null) return -1;
        try{
    ...
    public static int update( Connection cons, HoaDonVe h){
        if(cons == null) return -1;
        try{

 ...
 * @author Lenovo
 */
public class QuanLyHangHoa_NV extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(QuanLyHangHoa_NV.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyHangHoa_NV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
